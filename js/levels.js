    ...
    const definitions = [
        ...
        // Level 14: "X-Cross" - Speed Maze
        {
            pairs: [
                ...
                { type: T.TRIANGLE, positions: [[15, 15], [85, 85]] },
                { type: T.DIAMOND, positions: [[85, 15], [15, 85]] },
            ],
            obstacles: [
                { x: 35, y: 35, w: 6, h: 6 }, // Center-top-left
                { x: 59, y: 35, w: 6, h: 6 }, // Center-top-right
                { x: 35, y: 59, w: 6, h: 6 }, // Center-bottom-left
                { x: 59, y: 59, w: 6, h: 6 }, // Center-bottom-right
            ],
            mode: 'speed',
            timeLimit: 45,
            message: 'msg_speed',
